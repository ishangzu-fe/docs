...
4. 打包时需下载指定的 Electron 版本，也有可能遇到网络问题，可以自己对应的 Electron 版本并放到各系统的默认缓存目录中，例如，MacOS 缓存目录是：`~/Library/Caches/electron` 。具体可参考：https://github.com/electron-userland/electron-download
